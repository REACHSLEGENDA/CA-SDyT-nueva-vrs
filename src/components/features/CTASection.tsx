    ...
    return (
        <section className="py-20 md:py-32 relative overflow-hidden bg-transparent">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <BorderBeam size="md" colorVariant="colorful" duration={5} className="max-w-5xl mx-auto bg-brand-black/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 overflow-hidden relative group">
