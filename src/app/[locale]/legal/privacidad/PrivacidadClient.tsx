        ...
        <Section className="pt-32 pb-20">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="prose prose-invert max-w-none text-gray-300">
                    ...
                    <p className="mb-4">
                        Si tiene preguntas sobre esta política de privacidad, por favor contáctenos en: <a href="mailto:contacto@casolutecdigital.com" className="text-brand-blue hover:underline">contacto@casolutecdigital.com</a>
                    </p>
                </div>
            </div>
        </Section>
