...
export default function Home() {
  return (
    <>
      {/* Video Intro */}
      <div className="relative w-full h-[50vh] md:h-[80vh] overflow-hidden border-b border-white/5">
      ...
      {/* Hero */}
      <section className="relative pt-20 pb-32 lg:pt-32 lg:pb-40 overflow-hidden min-h-[600px] flex items-center bg-transparent">

        {/* Global background particles - handled in Layout */}
